...
| Номер изображения, обязательное описание и формирование имени загружаемого файла | [pict/models.md](docs/pict/models.md) | [pict/forms.md](docs/pict/forms.md), [pict/admin.md](docs/pict/admin.md), [pict/tests.md](docs/pict/tests.md), [migrations/README.md](docs/migrations/README.md) |
| Готовые работы, типы стекла/скинали, их связь с каталогом и публичная фотогалерея | [pict/models.md](docs/pict/models.md) | [pict/forms.md](docs/pict/forms.md), [pict/views.md](docs/pict/views.md), [pict/admin.md](docs/pict/admin.md), [pict/urls.md](docs/pict/urls.md) |
...
| Индивидуальная страница изображения, стабильный slug и похожие изображения | [pict/views.md](docs/pict/views.md), [pict/models.md](docs/pict/models.md), [pict/urls.md](docs/pict/urls.md) | [pict/admin.md](docs/pict/admin.md), [pict/sitemaps.md](docs/pict/sitemaps.md), [pict/tests.md](docs/pict/tests.md), [migrations/README.md](docs/migrations/README.md) |
