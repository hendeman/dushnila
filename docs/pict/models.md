...
Определяет доменные модели каталога, готовых работ и связи между ними.
...
Все три классификатора связаны с изображением отношением многие-ко-многим. `FinishedWork` связан с `Pict` отношением многие-к-одному: одна работа использует не более одного изображения каталога, а изображение может использоваться в нескольких работах.
