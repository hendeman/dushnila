...
Сводка всех Python-файлов в `skinali/pict/migrations/`. Миграции образуют линейную цепочку от `0001` до `0020`; `__init__.py` пуст и только обозначает пакет.
...
- `ContactRequest` хранит валидные заявки обоих типов независимо от каталога и сортирует их от новых к старым.
