...
Корневой URLconf проекта. Подключает административную панель, правила для поисковых роботов, XML-карту сайта, маршруты приложения, debug toolbar, media в разработке и обработчик 404.
